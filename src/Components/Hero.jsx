       ...
       align-items-center gap-2"
        >
          <div className="col-md-5" style={{ marginLeft: "auto" }}>
            <h3 className="hero-header text-white">
              Unlock Your Learning and Creative Potential
            </h3>
            ...
            <div data-bs-toggle="modal" data-bs-target="#waitlist">
              <button
                className="btn btn-lg px-4 hero-btn mt-3"
                style={{
              ...
              >
                Join the waitlist{" "}
                <FiArrowRight style={{ marginBottom: "2px" }} />
              </button>
            </div>
          </div>
